    ...
    return (
        <div>
            ...
            <div className="products">
                <h2 className="products-title">패브릭</h2>
                <div className='products-tab'>
                    <Radio.Group onChange={onChange} defaultValue={selectedValue} className='products-tab-menu'>
                        ...
                        <Radio.Button className='products-tab-item' value="b">패브릭</Radio.Button>
                        <Radio.Button className='products-tab-item' value="c">생활</Radio.Button>
                    </Radio.Group>
                </div>
